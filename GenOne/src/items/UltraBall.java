...
public class UltraBall extends Items {
	...
	public UltraBall() {
		this.itemName = "Ultra ball";
		this.icon = "Ultra_Ball_Item_Sprite.png";
		this.itemType = 1;
		this.itemID = 3;
		this.ballRate = 2;
	}
	...
	public void catchPokemon(BattleElements b1, Monsters m1) {
		...
		itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_01.png", 35, 35));
		x = 110;
		y = 290;
		z = 0;
		...
		timer = new Timer(2, new ActionListener() {
			...
			@Override
		      public void actionPerformed(ActionEvent e) {
				...
				if (x == 410) {
					itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_02.png", 35, 35));
				...
				if (x == 440) {
					itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_03.png", 35, 45));
	...
	private void jiggle(BattleElements b1, Monsters m1, boolean capture) {
		...
		timer = new Timer(25, new ActionListener() {
		      ...
		      public void actionPerformed(ActionEvent e) {
		    	  if (x == 15) {
		    		  itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_Jiggle_01.png", 35, 35));
		    		  b1.getBattleLpane().revalidate();
		    		  b1.getBattleLpane().repaint();
		    	  }
		    	  if (x == 10 || x == 20) {
		    		  itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_Jiggle_02.png", 35, 35));
		    		  b1.getBattleLpane().revalidate();
		    		  b1.getBattleLpane().repaint();
		    	  }
		    	  if (x == 5 || x == 25 || x == 45) { 
		    		  itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_Jiggle_03.png", 35, 35));
		    		  b1.getBattleLpane().revalidate();
		    		  b1.getBattleLpane().repaint();
		    	  }	
		    	  if (x == 30 || x == 40) {
		    		  itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_Jiggle_04.png", 35, 35));
		    		  b1.getBattleLpane().revalidate();
		    		  b1.getBattleLpane().repaint();
		    	  }
		    	  if (x == 35) {
		    		  itemSprite.setIcon(loadItemEffect("Ultra_Ball_Sprite_Jiggle_05.png", 35, 35));
		    		  b1.getBattleLpane().revalidate();
		    		  b1.getBattleLpane().repaint();
		    	  } 
		    	  x++;
